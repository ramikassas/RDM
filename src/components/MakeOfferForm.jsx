        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          ...
          {isUnstoppable && !isSold ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Available on Unstoppable Domains</h3>
              <p className="text-slate-600 mb-6">
                This domain is managed via Unstoppable Domains. You can purchase it directly on their platform.
              </p>
              <a 
              ...
              >
                <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12">
                  View on Unstoppable Domains <Globe className="ml-2 h-4 w-4" />
                </Button>
              </a>
              <div className="mt-4">
